                ...
                <div class="panel panel-white">
                    ...
                    <div class="panel-body user-profile-panel">
                        ...
                        {!! Form::open(["url" => route('admin.users.destroy', ['id' => $user->id]), 'method' => "DELETE"]) !!}
                            <button class="btn btn-danger btn-block" onclick="confirm('Вы урены что хотите удалить пользователя?')">@lang("admin.delete_user")</button>
                        {!! Form::close() !!}
                ...
                <div class="profile-timeline">
                    <ul class="list-unstyled">
                        <li class="timeline-item">
                            ...
                            {!! Form::open(["url" => route('admin.users.update', ["id" => $user->id]), "method" => "PUT", 'enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class="panel panel-white">
                                        ...
                                        <div style="float: right; margin-bottom: 10px">
                                            ...
                                            <input type="submit" id="enable" class="btn btn-default" value="{{ trans("admin.update") }}">
